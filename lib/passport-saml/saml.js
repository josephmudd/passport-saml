...
SAML.prototype.generateServiceProviderMetadata = function( decryptionCert, signingCert ) {
  ...
  if (this.options.logoutCallbackUrl) {
    metadata['md:EntityDescriptor']['md:SPSSODescriptor'].SingleLogoutService = {
  ...
  if (this.options.identifierFormat) {
    metadata['md:EntityDescriptor']['md:SPSSODescriptor'].NameIDFormat = this.options.identifierFormat;
  }
